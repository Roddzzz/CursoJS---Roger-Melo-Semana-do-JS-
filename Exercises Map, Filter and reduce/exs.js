...
const numbersImpar = randomNumbers.filter(num => num % 2 === 1)
...
const numbersAbove501 = crazyNumbers.filter(num => num < 501)

console.log(numbersAbove501);
...
const numbersExponential2 = numbers.map(num => num**2)

console.log(numbersExponential2);
...
const moviesBeforeY2000 = tarantinoMovies.filter(mov => mov.release < 2000)

console.log(moviesBeforeY2000);
...
const series = tvShows.map(tvSerie => tvSerie.name)
